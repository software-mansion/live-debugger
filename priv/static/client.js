(()=>{var U=`<div id="live-debugger-debug-button" part="debug-button">
  <svg
    viewBox="0 0 24 24"
    width="24"
    height="24"
...
`;function w(e){let t=document.createElement("div");return t.innerHTML=e,t.firstElementChild}function a(e,t={}){let o=new CustomEvent(e,t);document.dispatchEvent(o)}function E(){let e=w(U),t=!1,o=()=>{t?i():a("lvdbg:debug-button-click",{detail:{buttonRect:e.getBoundingClientRect()}})},n=()=>{t=!0,e.style.cursor="grabbing",document.addEventListener("mousemove",l)},i=()=>{t=!1,e.style.cursor="pointer",document.removeEventListener("mousemove",l)},l=s=>{let g=e.offsetWidth,m=e.offsetHeight,d=window.innerWidth-g,h=window.innerHeight-m,v=Math.max(0,Math.min(s.clientX-g/2,d)),f=Math.max(0,Math.min(s.clientY-m/2,h));e.style.left=`${v}px`,e.style.top=`${f}px`,e.style.right="auto",e.style.bottom="auto"},r=()=>{let s=e.getBoundingClientRect();s.top>=0&&s.left>=0&&s.bottom<=window.innerHeight&&s.right<=window.innerWidth||(e.style.left="auto",e.style.top="auto",e.style.right="20px",e.style.bottom="20px")};return e.addEventListener("click",o),document.addEventListener("lvdbg:move-button-click",n),window.addEventListener("resize",()=>r()),e}var R=`<div id="live-debugger-debug-tooltip">
  <div
...
`;function L({liveDebuggerURL:e,debugChannel:t}){let o=w(R),n=!1,i=d=>{o.style.display="block";let h=o.getBoundingClientRect(),v=h.width,f=h.height;d.right+v>window.innerWidth?o.style.left=`${d.left-v}px`:o.style.left=`${d.right}px`,d.top+f>window.innerHeight?o.style.top=`${d.bottom-f}px`:o.style.top=`${d.top}px`,n=!0},l=()=>{o.style.display="none",n=!1},r=d=>{let h=d.detail.buttonRect;n?l():i(h)},s=()=>{window.open(e,"_blank"),l()},g=()=>{a("lvdbg:inspect-button-click"),l()},m=()=>{a("lvdbg:move-button-click"),l()};return o.querySelector("#live-debugger-debug-tooltip-open-in-new-tab").addEventListener("click",s),o.querySelector("#live-debugger-debug-tooltip-inspect-elements").addEventListener("click",g),o.querySelector("#live-debugger-debug-tooltip-move-button").addEventListener("click",m),document.addEventListener("lvdbg:debug-button-click",r),document.addEventListener("lvdbg:click-outside-debug-menu",l),t.on("inspect-mode-changed",l),window.addEventListener("resize",()=>{n&&l()}),o}function O(){return new Promise(e=>{let t=document.querySelectorAll("[data-phx-session]"),o={},n=document.querySelector("[data-phx-main]")?.id,i=r=>{de(r)&&(ce(o,r.target),ue(o,t)&&(l.disconnect(),e({mainSocketID:n,rootSocketIDs:ae(o,n)})))},l=new MutationObserver(r=>{r.forEach(i)});t.forEach(r=>{l.observe(r,{attributes:!0})})})}function de(e){return e.type==="attributes"&&e.attributeName==="data-phx-root-id"}function ce(e,t){e[t.id]=t.getAttribute("data-phx-root-id")}function ue(e,t){return Object.keys(e).length>=t.length}function ae(e,t){let o=new Set(Object.values(e));return o.delete(t),[...o]}function P(){let e=document.querySelector('meta[name="live-debugger-config"]');if(e)return e;{let t=`
