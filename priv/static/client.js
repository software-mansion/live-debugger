(()=>{window.getLiveDebuggerURL=function(){return document.getElementById("live-debugger-scripts").src.replace("/assets/live_debugger/client.js","")};window.getSessionId=function(){return document.querySelector("[data-phx-main]").id};document.addEventListener("DOMContentLoaded",function(){let l=getLiveDebuggerURL(),s=getSessionId(),d=`
      <div id="debug-button" style="
        ...
        right: 20px;
        cursor: grab;">
        <a href="${l}/transport_pid/${s}" target="_blank">
