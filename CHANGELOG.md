...
### Bug fixes
Bug: Checking if module has `:module_info` exported by @kraleppa in #731
Bug: Weird css behaviour on flash and fullscreen by @srzeszut in #727
Bug: Fix truncated tooltip by @hhubert6 in #733
Bug: Lack of exception trace by @hhubert6 in #732
...
### Other
Chore: Change version to v0.4.0-dev by @kraleppa in #524
...
### Refactors
Refactor: simplified routing and created `linked_view` hook by @kraleppa in #376
Refactor: Make LvProcess use ProcessService by @GuzekAlan in #394
...
Refactor: extracted logic and components from traces_live by @kraleppa in #466
Refactor: Udpate to lucide icons by @GuzekAlan in #456
...
### Enhancements:
Add custom LiveDebugger url config by @GuzekAlan in #442
Adjust required versions and correct `phoenix_live_view` dependency by @kraleppa in #419

### Bug fixes
Extension reload on any browser navigation by @hhubert6 in #418
Fix traces filtering by @hhubert6 in #443
...
### Bug fixes
Bug: fixed assigns refreshing after changing node by @kraleppa in #386
Bug: LiveDebugger stops working after code reload by @GuzekAlan in #391
...
### Bug fixes
Bug: Fix triggering highlighting on hover by @GuzekAlan in #353
Bug: add config to disable LiveDebugger by @kraleppa in #357
Bug: Fix traces separator after filters updated by @hhubert6 in #362

## 0.1.7 (2025-04-29)

### Enhancements:
Enhanced UI layout styling and accessibility by @GuzekAlan in #287
Updated styling for scrollbars by @kraleppa in #292
Improved components tree styling by @GuzekAlan in #291
Added `server` option to config by @kraleppa in #337

### Bug fixes
Fixed z-index of fullscreen button by @hhubert6 in #288
Fixed id multiplication from components tree by @GuzekAlan in #286
Fixed assigns not scrollable by @GuzekAlan in #294
Fixed components tree with only one node by @GuzekAlan in #326
