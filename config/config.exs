...
if config_env() == :dev do
  config :esbuild,
    version: "0.18.6",
    build_app_js_deploy: [
      args: ~w(app.js --bundle --minify --sourcemap=external --target=es2020 --outdir=../../priv/static/),
    ...
    build_app_js_dev: [
      args: ~w(app.js --bundle --sourcemap=external --target=es2020 --outdir=../../priv/static/dev),
      cd: Path.expand("../assets/app", __DIR__),
      env: %{"NODE_PATH" => Path.expand("../deps", __DIR__)}
    ],
    build_client_js_dev: [
