defmodule LiveDebugger.E2E.WindowDiscoveryTest do
  ...
  feature "user can see only active live views per window", %{
    ...
    |> assert_has(window_live_sessions(count: 1))
  ...
  defp window_live_sessions(count: count), do: css("#live-sessions ", count: count)
