    ...
    <div class="flex flex-col h-full overflow-x-auto w-full">
      ...
      <div class="grow p-8 overflow-y-auto scrollbar-main">
        <div class="w-full min-w-[25rem] max-w-screen-2xl mx-auto">
          ...
          <div
            class="@container/traces w-full min-w-[20rem] flex flex-col pt-2 shadow-custom rounded-sm bg-surface-0-bg border border-default-border"
            id="global-traces-section"
          >
