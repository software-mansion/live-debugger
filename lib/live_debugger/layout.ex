defmodule LiveDebugger.Layout do
  ...
  def render("root.html", assigns) do
    ...
    <html lang="en">
      ...
      <body class="theme-dark text-primary-text bg-main-bg text-xs font-normal">
        <span
          id="tooltip"
          class="absolute hidden p-1 text-xs bg-surface-0-bg border-1 border-primary rounded-md shadow-md"
        >
        </span>
        <%= @inner_content %>
      </body>
