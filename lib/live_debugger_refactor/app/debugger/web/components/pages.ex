defmodule LiveDebuggerRefactor.App.Debugger.Web.Components.Pages do
  @moduledoc """
  ...
  alias LiveDebuggerRefactor.App.Debugger.CallbackTracing.Web, as: CallbackTracingWeb
  alias LiveDebuggerRefactor.App.Debugger.Web.LiveComponents.NodeInspectorSidebar
  alias LiveDebuggerRefactor.App.Debugger.Web.LiveComponents.NodeBasicInfo
  alias LiveDebuggerRefactor.App.Debugger.ComponentsTree.Web.ComponentsTreeLive
  alias LiveDebuggerRefactor.App.Debugger.NodeState.Web.NodeStateLive
  alias LiveDebuggerRefactor.App.Debugger.NestedLiveViewLinks.Web.NestedLiveViewLinksLive
