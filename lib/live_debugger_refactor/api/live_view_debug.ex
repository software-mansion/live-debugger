defmodule LiveDebuggerRefactor.API.LiveViewDebug do
  @moduledoc """
  ...
  defmodule Impl do
    @moduledoc false
    @behaviour LiveDebuggerRefactor.API.LiveViewDebug

    if LiveDebuggerRefactor.API.System.Module.loaded?(Phoenix.LiveView.Debug) do
      @impl true
